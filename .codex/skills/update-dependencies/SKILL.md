...
description: Update this repository's dependencies and tooling to current/latest local versions. Use when Codex is asked to refresh Go modules, Nix flake inputs, Docker base images, GitHub Actions, pre-commit hooks, Renovate-managed versions, or other dependency pins in helmizer. All work must stay local: do not create git commits, tags, pushes, pull requests, or releases.
---
